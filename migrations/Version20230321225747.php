 ...
 */
final class Version20230321225747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chronologie CHANGE chronologie_text_en chronologie_text_en LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE options ADD option_images LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chronologie CHANGE chronologie_text_en chronologie_text_en LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE options DROP option_images');
    }
}
