 ...
 */
final class Version20230302132514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE option_models ADD CONSTRAINT FK_A78632DE3ADB05F1 FOREIGN KEY (options_id) REFERENCES options (id)');
