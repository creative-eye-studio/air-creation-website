 ...
 */
final class Version20230322220039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE options CHANGE option_images options_images LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE options CHANGE options_images option_images LONGTEXT DEFAULT NULL');
    }
}
